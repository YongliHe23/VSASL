...
base_pulse =  'sinc_mod'; %'sinc_2lobe'; % 'sinc_mod_90'; %'sinc_mod_90'; % 'sinc_mod'   % 'sinc'  % 'hard'; % sech, hard, BIR 'hard_90'
...
switch base_pulse
    ...
    case 'sinc_2lobe'
        ...
        mySinc_dur = 1.44; % ms - 17268 pulse (9 x 0.4) 
        %mySinc_dur = 4; % ms
        
        mySinc_dur = round(mySinc_dur/dt/Nsegs) * Nsegs*dt; % ms
        mySinc = sinc(linspace(-2, 2,   mySinc_dur/dt))' ;
...
vel_range = linspace(-40, 40, 100) * 1e-3;
