...
etTR=0.081; %echo-train TR
vTR=etTR*nz/mb;

nDummyFrames = 0;
nFrames = 8;
if TODO(1)
    [gro, adc] = writeEPI(voxelSize, [nx ny nz], TE, vTR, alpha, mb, pf_ky, Ry, Rz, caipiShiftZ, nFrames, nDummyFrames, '3D', ...
    ...
    nRuns = dur/(nFrames*vTR);     % CV8/opuser8 on UI
end
%%
...
if TODO(2)
    writeEPI(voxelSize, [nx ny nz], TE, vTR, alpha, mb, pf_ky, Ry, Rz, caipiShiftZ, nFrames, nDummyFrames, '3D', ...
        'seqName', 'cal', ...
        'fatSat', fatSat, ...
        'RFspoil', RFspoil, ...
        'toGE', toGE, ...
...
nFrames = 1; 
if TODO(3)
    writeEPI(voxelSize, [nx ny nz], TE, 2*6*vTR, alpha, mb, pf_ky, Ry, Rz, caipiShiftZ, nFrames, nDummyFrames, 'SMS', ...
        'seqName', '2d', ...
        'fatSat', fatSat, ...
        'RFspoil', RFspoil, ...
        'toGE', toGE, ...
...
nFrames = 2; 
if TODO(4)
    writeEPI(voxelSize, [nx ny nz], TE, 2*6*vTR, 90, mb, pf_ky, Ry, Rz, caipiShiftZ, nFrames, nDummyFrames, 'SE', ...
        'seqName', '2dse', ...
        'fatSat', false, ...
        'RFspoil', false, ...
        'toGE', toGE, ...
...
vTR=etTR*(nz/mb);
if TODO(7)
     writeEPI_vsasl(voxelSize, [nx ny nz], TE, vTR, alpha, mb, pf_ky, Ry, Rz, caipiShiftZ, nFrames, nDummyFrames, '3D', ...
...
vTR=nz*etTR;
if TODO(8)
     writeEPI_vsasl_multishot(voxelSize, [nx ny nz], TE, vTR, alpha, mb, pf_ky, Ry, Rz, caipiShiftZ, nFrames, nDummyFrames, '3D', ...
        'seqName', sprintf('3dmb%d_beta', mb), ...
        'fatSat', fatSat, ...
        'RFspoil', RFspoil, ...
        'toGE', toGE, ...
